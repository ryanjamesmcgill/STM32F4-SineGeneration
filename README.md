...
<p>
The armStrap is a nice alternative to the STM32F4 Discovery board because it allows you develop on tools that are all free and available for Linux, Windows, and OSX. More info: (http://armstrap.org/)
<p>
